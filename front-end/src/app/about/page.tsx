...
export default function About() {
  ...
  const aboutText = [
  "Hi, it's nice to meet you. I'm Koby, and I've set my mind on software since my years in elementary school. The first legitimate language I ever laid my hands on was RobotC, which I used a general engineering course during junior high.",
  ...
  "In 2019, I left my traditional highschool in order to provide myself an even better education, where I was finally able to take my first computer science course.",
